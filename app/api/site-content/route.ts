...
import { salesPagePatchSchema, siteContentInputSchema } from '@/lib/validators';
...
export async function PATCH(request: Request) {
  ...
  try {
    const body = await request.json();
    const parsed = salesPagePatchSchema.safeParse(body);
    ...
    return jsonServerError('SITE_CONTENT_PATCH', 'No se pudo guardar el contenido de la página', error);
  }
}
